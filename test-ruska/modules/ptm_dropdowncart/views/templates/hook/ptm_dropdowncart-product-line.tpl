        ...
        <ul>
            {foreach from=$product.customizations item="customization"}
                <li>
                    ...
                    <a href="{$customization.remove_from_cart_url}" title="{l s='remove from cart' mod='ptm_dropdowncart'}" class="remove-from-cart ajax_cart_block_remove_link" data-product-customization="{$customization.id_customization}" data-product="{$product.id_product}" data-product-attribute="{$product.id_product_attribute}" rel="nofollow"><i class="material-icons">&#xE888;</i></a>
